...
public class MachineEntity {
    ...
    private List<NetworkCard> pmNetworkCards;
    private List<Cpu> pmCpus;
    private List<Memory> pmMemories;
    ...
    public List<NetworkCard> getPmNetworkCards() {
        return pmNetworkCards;
    }

    public void setPmNetworkCards(List<NetworkCard> pmNetworkCards) {
    ...
    public List<Cpu> getPmCpus() {
        return pmCpus;
    }

    public void setPmCpus(List<Cpu> pmCpus) {
        this.pmCpus = pmCpus;
    }

    public List<Memory> getPmMemories() {
        return pmMemories;
    }

    public void setPmMemories(List<Memory> pmMemories) {
